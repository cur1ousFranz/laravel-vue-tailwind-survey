<template>
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
      <div v-for="survey in surveys" :key="survey.id" class="flex flex-col py-4 px-6 shadow-md bg-white
      hover:bg-gray-50 h-[470px]">
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
          >
