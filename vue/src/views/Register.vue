    ...
    <div>
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
           Or
          <router-link class="text-blue-500" :to="{ name : 'Login'}">login now</router-link>
        </p>
      </div>
      <form class="mt-8 space-y-6" @submit.prevent="register">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div>
            ...
            <input v-model="user.name" id="fullname" name="fullname" type="text" required class="relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Full Name">
          </div>
          <div>
            <label for="email-address" class="sr-only">Email address</label>
            <input v-model="user.email" id="email-address" name="email" type="email" autocomplete="email" required class="relative block w-full appearance-none rounded-none border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Email address">
          </div>
          <div>
