  ...
  <div class="flex flex-col justify-between">
    <div class="flex items-center justify-between">
      ...
      <div class="flex flex- items-center">
        <button type="button" @click="addQuestion" class="flex items-center text-xs py-1 px-3 mr-2
        ...
        <button type="button" @click="deleteQuestion" class="flex items-center text-xs py-1 px-3
        rounded border border-transparent text-red-500 hover:border-red-500">
          Delete
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
    ...
    <div class="grid gap-3 grid-cols-12">
      ...
      <div class="mt-3 col-span-9">
        ...
        <input type="text" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block
      ...
      <div class="mt-3 col-span-3">
        ...
        >
          <option :value="type" v-for="type in questionTypes" :key="type">
            {{ upperCaseFirst(type) }}
          </option>
        </select>
      </div>
    ...
    <div class="mt-3 col-span-9">
      ...
      <textarea :name="'question_description'" :id="'question_description'" v-model="model.description"
      @change="dataChange" class="mt-1  focus:ring-indigo-500 focus:border-indigo-500 block
        w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
      />
    </div>
    <hr class="mt-4">
    <div class="">
      <div v-if="shouldHaveOptions()" class="mt-2">
        <h4 class="text-sm font-semibold mb-1 flex justify-between items-center">
          ...
          <button type="button" @click="addOption()" class="flex items-center text-xs py-1 px-2 rounded-sm
        ...
        <button type="button" @click="removeOption(option)" class=" h-6 w-6 rounded-full flex items-center
            justify-center border border-transparent transition-colors hover:border-red-100">
